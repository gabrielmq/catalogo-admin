...
public class UpdateCategoryUseCaseIT {
    ...
    public void givenAValidCommand_whenCallsUpdateCategory_thenShouldReturnCategoryId() {
        final var aCategory =
                Category.newCategoryWith("Film", null, true);
        ...
        assertEquals(aCategory.getCreatedAt(), actualCategory.getCreatedAt().toEpochMilli());
    ...
    public void givenAValidCommand_whenGatewayThrowsRandomException_thenShouldReturnAException() {
        ...
        assertEquals(aCategory.getCreatedAt(), actualCategory.getCreatedAt().toEpochMilli());
        assertEquals(aCategory.getUpdatedAt(), actualCategory.getUpdatedAt().toEpochMilli());
        assertEquals(aCategory.getDeletedAt(), actualCategory.getDeletedAt().toEpochMilli());
    }
